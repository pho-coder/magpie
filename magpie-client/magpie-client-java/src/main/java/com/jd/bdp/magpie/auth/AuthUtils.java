package com.jd.bdp.magpie.auth;
...
public class AuthUtils {
    ...
    public static Configuration GetConfiguration(Map magpie_conf) {
        ...
        String loginConfigurationFile = (String)magpie_conf.get("java.security.com.jd.bdp.magpie.auth.login.config");
    ...
    public static ITransportPlugin GetTransportPlugin(Map magpie_conf, Configuration login_conf) {
        ...
        try {
            String transport_plugin_klassName = "com.jd.bdp.magpie.auth.SimpleTransportPlugin";
